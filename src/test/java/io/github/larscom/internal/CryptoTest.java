...
class CryptoTest {
    ...
    void testCreateSignatureWithBody() throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        final var signature = Crypto.createSignature("GET", "/test", Optional.of(body.getBytes()), timestamp, "API_SECRET");
    ...
    void testCreateSignatureNoBody() throws NoSuchAlgorithmException, InvalidKeyException {
        final var timestamp = 1721452468484L;
        final var signature = Crypto.createSignature("GET", "/test", Optional.empty(), timestamp, "API_SECRET");
